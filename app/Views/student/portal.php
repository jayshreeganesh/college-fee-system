...
<body class="bg-slate-50 min-h-screen">
    ...
    <div class="max-w-6xl mx-auto p-8 mt-8">
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
            <h2 class="text-3xl font-bold text-slate-800 mb-6">Welcome back, <?php echo htmlspecialchars($studentData['name']); ?>!</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-blue-50 border border-blue-100 p-6 rounded-2xl">
                    ...
                    <p class="text-3xl font-extrabold text-blue-600 mt-2">$<?php echo number_format($totalPaid, 2); ?></p>
                </div>
                <div class="bg-red-50 border border-red-100 p-6 rounded-2xl">
                    <h3 class="text-lg font-bold text-red-800">Pending Dues</h3>
                    <p class="text-3xl font-extrabold text-red-600 mt-2">$<?php echo number_format($pendingDues, 2); ?></p>
                </div>
                <div class="bg-green-50 border border-green-100 p-6 rounded-2xl">
                    ...
                    <p class="text-xl font-bold text-green-600 mt-2"><?php echo htmlspecialchars($lastTransaction); ?></p>
                </div>
            </div>
        </div>
    </div>
