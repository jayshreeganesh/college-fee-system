    ...
    <div class="max-w-7xl mx-auto p-8 mt-4">
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex gap-4">
                ...
                <a href="/admin/emails" class="flex items-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-xl shadow-md transition-all transform hover:-translate-y-1">
