    ...
    <div class="flex-1 lg:overflow-hidden p-4 md:p-6 max-w-[1920px] mx-auto w-full flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-[280px] shrink-0 flex flex-col gap-6 lg:overflow-y-auto custom-scrollbar lg:pr-2 lg:pb-6">
            ...
            <div class="bg-white dark:bg-slate-800 dark:border-slate-700 rounded-3xl shadow-sm border border-slate-100 p-4 flex flex-col gap-2">
                ...
                <a href="/admin/send-reminders" class="flex items-center gap-3 px-4 py-3 bg-indigo-50 dark:bg-indigo-900/30 hover:bg-indigo-100 dark:hover:bg-indigo-800 text-indigo-700 dark:text-indigo-300 hover:text-indigo-800 dark:hover:text-indigo-200 font-bold rounded-xl transition-all border border-indigo-200 dark:border-indigo-800 shadow-sm" onclick="return confirm('This will generate simulated reminder emails for ALL students with pending fees. Proceed?')">
